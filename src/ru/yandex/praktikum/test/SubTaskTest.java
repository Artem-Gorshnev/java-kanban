...
class SubTaskTest {
    ...
    public void subtasksShouldBeEqualIfTheirIdIsEqual() {
        Task epic = new Epic("Эпик 1", "Описание 1", 1);
        Task task1 = new SubTask("Подзадача 1", "Описание 1", StatusTask.NEW, 1, 1);
        Task task2 = new SubTask("Подзадача 2", "Описание 2", StatusTask.DONE, 1, 1);
